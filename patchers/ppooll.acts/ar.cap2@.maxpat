...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -1.0, 44.5, 132.0, 20.0 ],
					"slidermax" : 1.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -1.0, 73.5, 132.0, 20.0 ],
					"slidermax" : 1.0,
					"textcolornofocus" : [ 0.694117647058824, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "capLP"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -1.0, 104.5, 132.0, 20.0 ],
					"slidermax" : 1.0,
					"textcolornofocus" : [ 0.694117647058824, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "capNL"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 18.0, 60.0, 10.0 ],
					"varname" : "preset-ramp"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 0.0, 69.0, 28.0 ],
					"varname" : "presets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 282.0, 30.5, 113.0, 22.0 ],
					"restore" : [ "in(2)" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -1.0, 133.5, 132.0, 20.0 ],
					"slidermax" : 1.0,
					"textcolornofocus" : [ 0.694117647058824, 0.0, 0.0, 0.788235294117647 ],
					"varname" : "capMix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 161.0, 131.0, 53.0 ],
					"varname" : "ll.blues",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -1.0, 30.5, 160.0, 12.0 ],
					"varname" : "ll.inputmix",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 139.0, 178.0, 22.0 ],
					"text" : "actmaker ar.cap2@ \"204 102 0\"",
					"varname" : "act"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 429.0, 255.0, 63.0, 22.0 ],
									"text" : "ll.r capMix"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 440.0, 197.0, 59.0, 22.0 ],
									"text" : "ll.r capNL"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 274.0, 36.0, 61.0, 22.0 ],
									"text" : "ll.r capHP"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 59.5, 182.0, 84.0, 22.0 ],
									"text" : "ar.capacitor2~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 204.0, 81.0, 150.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 204.0, 256.15686274509801, 150.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 204.0, 199.104575163398692, 150.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 204.0, 150.052287581699318, 150.0, 22.0 ]
								}
...
,
					"patching_rect" : [ 322.0, 323.0, 63.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 97.0, 113.0, 22.0 ],
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.0, 118.0, 100.0, 22.0 ],
					"priority" : 					{
						"title_menu" : 2010,
						"pres_menu" : 2011,
						"tetris_menu" : 2012,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 282.0, 160.0, 107.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher",
					"varname" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 181.0, 107.0, 22.0 ],
					"text" : "pattrmarker no",
					"varname" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 282.0, 202.0, 107.0, 22.0 ],
					"restore" : 					{
						"capHP" : [ 0.484375 ],
						"capLP" : [ 0.453125 ],
						"capMix" : [ 0.681818181818182 ],
						"capNL" : [ 0.4609375 ],
						"master" : [ 0 ],
						"pres_menu" : [ "" ],
						"preset-ramp" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 295.0, 94.0, 100.0, 22.0 ],
					"restore" : [ "in(2)" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
